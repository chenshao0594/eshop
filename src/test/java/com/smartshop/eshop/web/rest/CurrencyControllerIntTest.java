...
public class CurrencyControllerIntTest {

    private static final String DEFAULT_CODE = "AAAAAAAAAA";
    private static final String UPDATED_CODE = "BBBBBBBBBB";

    private static final Boolean DEFAULT_SUPPORTED = false;
    private static final Boolean UPDATED_SUPPORTED = true;
    ...
    public void setup() {
        ...
        this.restCurrencyMockMvc = MockMvcBuilders.standaloneSetup(currencyController)
    ...
    public void createCurrency() throws Exception {
        ...
        assertThat(testCurrency.isSupported()).isEqualTo(DEFAULT_SUPPORTED);
    ...
    public void getAllCurrencies() throws Exception {
        ...
        restCurrencyMockMvc.perform(get("/api/currencies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].supported").value(hasItem(DEFAULT_SUPPORTED.booleanValue())))
    ...
    public void getCurrency() throws Exception {
        ...
        restCurrencyMockMvc.perform(get("/api/currencies/{id}", currency.getId()))
            ...
            .andExpect(jsonPath("$.supported").value(DEFAULT_SUPPORTED.booleanValue()))
    ...
    public void updateCurrency() throws Exception {
        ...
        assertThat(testCurrency.isSupported()).isEqualTo(UPDATED_SUPPORTED);
