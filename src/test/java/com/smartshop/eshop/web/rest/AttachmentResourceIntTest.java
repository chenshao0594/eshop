...
import com.smartshop.eshop.repository.AttachmentRepository;
import com.smartshop.eshop.service.AttachmentService;
import com.smartshop.eshop.repository.search.AttachmentSearchRepository;
...
public class AttachmentResourceIntTest {
    ...
    private static final String DEFAULT_BO_NAME = "AAAAAAAAAA";
    private static final String UPDATED_BO_NAME = "BBBBBBBBBB";

    private static final Long DEFAULT_BO_ID = 1L;
    private static final Long UPDATED_BO_ID = 2L;
    ...
    public void setup() {
        ...
        AttachmentController attachmentResource = new AttachmentController(attachmentService);
    ...
    public void createAttachment() throws Exception {
        ...
        assertThat(testAttachment.getBoName()).isEqualTo(DEFAULT_BO_NAME);
        assertThat(testAttachment.getBoId()).isEqualTo(DEFAULT_BO_ID);
    ...
    @Test
    @Transactional
    public void checkBoNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = attachmentRepository.findAll().size();
        // set the field null
        attachment.setBoName(null);
    ...
    @Test
    @Transactional
    public void checkBoIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = attachmentRepository.findAll().size();
        // set the field null
        attachment.setBoId(null);
    ...
    public void getAllAttachments() throws Exception {
        ...
        restAttachmentMockMvc.perform(get("/api/attachments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].boName").value(hasItem(DEFAULT_BO_NAME.toString())))
            .andExpect(jsonPath("$.[*].boId").value(hasItem(DEFAULT_BO_ID.intValue())));
    }
    ...
    public void getAttachment() throws Exception {
        ...
        restAttachmentMockMvc.perform(get("/api/attachments/{id}", attachment.getId()))
            ...
            .andExpect(jsonPath("$.boName").value(DEFAULT_BO_NAME.toString()))
            .andExpect(jsonPath("$.boId").value(DEFAULT_BO_ID.intValue()));
    }
    ...
    public void updateAttachment() throws Exception {
        ...
        assertThat(testAttachment.getBoName()).isEqualTo(UPDATED_BO_NAME);
        assertThat(testAttachment.getBoId()).isEqualTo(UPDATED_BO_ID);
