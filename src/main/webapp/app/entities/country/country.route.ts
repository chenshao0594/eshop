...
import { CountryPopupComponent, CountryDialogComponent } from './country-dialog.component';
...
export const countryRoute: Routes = [
  {
    ...
    data: {
        ...
        pageTitle: 'eshopApp.country.home.title'
    },
    canActivate: [UserRouteAccessService]
  }, {
    path: 'country-new',
    component: CountryDialogComponent,
    data: {
        authorities: ['ROLE_USER'],
        pageTitle: 'eshopApp.country.home.title'
    },
