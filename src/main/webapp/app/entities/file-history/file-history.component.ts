...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.fileHistoryService.search({
    ...
    transition() {
        this.router.navigate(['/file-history'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: FileHistory) {
        return item.id;
    }
