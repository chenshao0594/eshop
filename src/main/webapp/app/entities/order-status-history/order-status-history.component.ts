...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/order-status-history'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/order-status-history', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    registerChangeInOrderStatusHistories() {
        this.eventSubscriber = this.eventManager.subscribe('orderStatusHistoryListModification', (response) => this.loadAll());
    }
    ...
    private onSuccess(data, headers) {
        ...
        this.orderStatusHistories = data;
    }
