...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/optin'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Optin) {
        return item.id;
    }
    registerChangeInOptins() {
        this.eventSubscriber = this.eventManager.subscribe('optinListModification', (response) => this.loadAll());
    }
