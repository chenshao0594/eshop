...
public class OrderAccountProduct extends BusinessDomain<Long, OrderAccountProduct> implements Serializable {
	...
	public OrderAccountProduct orderAccountProductLastTransactionStatus(
	...
	public OrderAccountProduct orderAccountProductPaymentFrequencyType(
	...
	public OrderAccountProduct orderProduct(OrderProduct orderProduct) {
