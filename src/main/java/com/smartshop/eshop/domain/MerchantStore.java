...
public class MerchantStore extends BusinessDomain implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MerchantStore merchantStore = (MerchantStore) o;
        if (merchantStore.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, merchantStore.id);
    }
    ...
    public String toString() {
        return "MerchantStore{" +
            ...
            ", currencyFormatNational='" + currencyFormatNational + "'" +
            ", storepostalcode='" + storepostalcode + "'" +
            ", seizeunitcode='" + seizeunitcode + "'" +
            ", storestateprovince='" + storestateprovince + "'" +
