...
public interface CategoryService extends AbstractDomainService<Category, Long> {
	...
	void addChild(Category parent, Category child) throws ServiceException, com.smartshop.eshop.exception.ServiceException;
	...
	Category getByCode(MerchantStore store, String code) throws ServiceException;

	List<Category> listByStore(MerchantStore store, Language language) throws ServiceException;
	...
	List<Category> listByLineage(String storeCode, String lineage) throws ServiceException;
	...
	/**
	 * Returns a list by category containing the category code and the number of
	 * products 1->obj[0] = book obj[1] = 150 2->obj[0] = novell obj[1] = 35 ...
	 * 
	 * @param store
	 * @param categoryIds
	 * @return
	 ...
	 */
	List<Object[]> countProductsByCategories(MerchantStore store, List<Long> categoryIds) throws ServiceException;
	 ...
	 * @return
	 */
	List<Category> listByIds(MerchantStore store, List<Long> ids, Language language);
