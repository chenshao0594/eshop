...
public interface TaxRateRepository extends JpaRepository<TaxRate, Long> {
	...
	List<TaxRate> findByMerchantAndZoneAndCountryAndLanguage(Integer id, Long zoneId, Integer countryId,
			Integer languageId);
	...
	List<TaxRate> findByMerchantAndProvinceAndCountryAndLanguage(Integer id, String province, Integer countryId,
			Integer languageId);
