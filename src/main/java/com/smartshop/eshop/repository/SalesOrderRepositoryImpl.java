...
public class SalesOrderRepositoryImpl implements SalesOrderRepositoryCustom {
	...
	@Override
	public SalesOrderList listByStore(MerchantStore store, SalesOrderCriteria criteria) {

		SalesOrderList orderList = new SalesOrderList();
		...
		if (!StringUtils.isBlank(criteria.getCustomerName())) {
			String nameParam = new StringBuilder().append("%").append(criteria.getCustomerName()).append("%")
					.toString();
		...
		if (!StringUtils.isBlank(criteria.getPaymentMethod())) {
			String payementParam = new StringBuilder().append("%").append(criteria.getPaymentMethod()).append("%")
					.toString();
