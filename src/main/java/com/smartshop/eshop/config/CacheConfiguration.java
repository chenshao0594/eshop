...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.smartshop.eshop.domain.ProductOptionValue.class.getName() + ".descriptions", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.ProductPrice.class.getName() + ".descriptions", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.CustomerOptionValueDescription.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.ProductAvailability.class.getName() + ".prices", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.CustomerOption.class.getName() + ".descriptions", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.OrderProduct.class.getName() + ".orderAttributes", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.ShoppingCartItem.class.getName() + ".attributes", jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.MerchantStore.class.getName(), jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.MerchantStore.class.getName() + ".languages", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.OrderAccount.class.getName() + ".orderAccountProducts", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.ProductOption.class.getName() + ".descriptions", jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.ProductOptionValueDescription.class.getName(), jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.CustomerOptionValue.class.getName(), jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.CustomerOptionValue.class.getName() + ".descriptions", jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.ProductImage.class.getName(), jcacheConfiguration);
            cm.createCache(com.smartshop.eshop.domain.ProductImage.class.getName() + ".descriptions", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.Language.class.getName() + ".storesDefaultLanguages", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.ProductReview.class.getName() + ".descriptions", jcacheConfiguration);
            ...
            cm.createCache(com.smartshop.eshop.domain.Manufacturer.class.getName() + ".descriptions", jcacheConfiguration);
