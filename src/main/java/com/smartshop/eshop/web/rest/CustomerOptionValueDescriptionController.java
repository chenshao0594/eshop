...
public class CustomerOptionValueDescriptionController
		extends AbstractDomainController<CustomerOptionValueDescription, Long> {
	...
	public CustomerOptionValueDescriptionController(
			CustomerOptionValueDescriptionService customerOptionValueDescriptionService) {
