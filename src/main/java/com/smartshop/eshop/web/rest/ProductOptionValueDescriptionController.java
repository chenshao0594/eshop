...
public class ProductOptionValueDescriptionController extends AbstractDomainController< ProductOptionValueDescription, Long>{
    ...
    public ProductOptionValueDescriptionController(ProductOptionValueDescriptionService productOptionValueDescriptionService) {
