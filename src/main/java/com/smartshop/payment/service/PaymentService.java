...
public interface PaymentService {
	...
	Transaction processPayment(Customer customer, MerchantStore store, PaymentDTO payment, List<ShoppingCartItem> items, SalesOrder order) throws BusinessException;
	Transaction processRefund(SalesOrder order, Customer customer, MerchantStore store, BigDecimal amount) throws BusinessException;
	...
	Transaction processCapturePayment(SalesOrder order, Customer customer,
			MerchantStore store)
			throws BusinessException;

	List<PaymentMethodDTO> getAcceptedPaymentMethods(MerchantStore store)
			throws BusinessException;
