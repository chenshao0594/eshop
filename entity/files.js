    ...
    server: [
        {
            ...
            templates: [
                ...
                {
                    file: 'package/web/rest/_EntityController.java',
                    renameTo: generator => `${generator.packageFolder}/web/rest/${generator.entityClass}Controller.java`
                }
            ]
        },
        {
    ...
    test: [
        {
            ...
            templates: [{
                file: 'package/web/rest/_EntityControllerIntTest.java',
                options: { context: { randexp, _, chalkRed: chalk.red, fs, SERVER_TEST_SRC_DIR } },
                renameTo: generator => `${generator.packageFolder}/web/rest/${generator.entityClass}ControllerIntTest.java`
            }]
        },
        {
